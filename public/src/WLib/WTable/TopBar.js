...
export default (function (params) {
    var args = params.args, actions = params.actions;
    var searchable = args.searchable, actionItems = args.actionItems;
    return Div({
        children: [
            Row({
                children: [
        ...
        children: [
            Row({
                children: [
                    ...
                    TextInput({
                        onKeyUp: function (e) { return dispatch(actions.filterTable(e.target.value)); },
                        style: {
                            border: 'none',
                            outline: 'none',
                            borderRadius: '4px',
